...
jsPsych.plugins["html-button-response-captcha"] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'html-button-response-captcha',
    description: '',
    parameters: {
      stimulus: {
      ...
      button_html: {
        ...
        default: '<button class="jspsych-btn" disabled="true" id="continuar">%choice%</button>',
        array: true,
