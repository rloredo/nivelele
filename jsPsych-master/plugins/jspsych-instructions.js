    ...
    function show_current_page() {
      ...
      if (trial.show_clickable_nav) {
        ...
        if (current_page != 0 && trial.allow_backward) {
          nav_html += "<button id='jspsych-instructions-back' class='jspsych-btn-back' style='margin-right: 5px;'>&lt; "+trial.button_label_previous+"</button>";
        }
        nav_html += "<button id='jspsych-instructions-next' class='jspsych-btn-next' style='margin-left: 5px;'>"+trial.button_label_next+" &gt;</button></div>"
