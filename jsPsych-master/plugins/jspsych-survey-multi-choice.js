...
jsPsych.plugins['survey-multi-choice'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var cssstr = ".jspsych-survey-multi-choice-question { margin-top: 2em; margin-bottom: auto; text-align: left; }"+
    ...
    // add submit button
    trial_form.innerHTML += '<input type="submit" id="'+plugin_id_name+'-next" class="'+plugin_id_name+' jspsych-btn-preg"' + (trial.button_label ? ' value="'+trial.button_label + '"': '') + '></input>';
