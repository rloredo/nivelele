...
//A1
var preguntas_A1G1 = ["<div id='n_preg'></div><p>Mi hermano nunca _______ temprano por la mañana porque trabaja por la tarde.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_A1G2 = ["<p>Creo que tu casa es ________ bonita.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_A1G3 = ["<p>¿Quieres _______ a mi casa para estudiar?</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_A1L1 = ["<p>¿Sabes dónde ______ una farmacia cerca de aquí?</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_A1L2 = ["<p>______ sábado voy al teatro.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_A1L3 = ["<p>Mi hermano es __________ de Química en la universidad y tiene estudiantes de todo el mundo.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_A1F1 = ["<p>- __________________</p><p>- Soy francesa, ¿y tú?</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_A1F2 = ["<p>- Creo que estudiar español es muy importante.</p><p>- ________________________.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_A2G1 = ["<p>- Sandra, ¿qué te gustaba hacer cuando ______ niña?</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_A2G2 = ["<p>- ¿Qué vas a hacer este domingo?</p><p>- Voy a ___________ temprano para correr un rato en el parque y luego voy a almorzar con mis padres. ¿Y tú?</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_A2G3 = ["<p>- Hace mucho frío aquí.</p><p>- Sí, está abierta la ventana. Por favor, ________ tú. Yo no llego porque está muy alta.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_A2G4 = ["<p>¿Qué cenamos hoy?</p><p>No sé, no hay _______ para cocinar. Podemos comprar un poco de queso y tomate para hacer una pizza.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_A2L1 = ["<p>Julián, mañana es el concierto, ¿_____ has comprado las entradas?</p><p>No, no he tenido tiempo.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_A2L2 = ["<p>Mis padres y mi hermano menor viven en Colombia, pero mi hermano _____ vive en México porque está estudiando allí.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_A2L3 = ["<p>¿Cuándo aprendiste a _________la guitarra?</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_A2F1 = ["<p>Tengo tiempo libre este fin de semana, ¿y tú?</p><p>¡Yo también! __________________</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_A2F2 = ["<p>Ricardo, hoy no voy a poder ir al concierto contigo porque _______ estudiar para un examen.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B1G1 = ["<p>- ¿Qué pasó anoche? ¿Por qué llegaste tan tarde a la cena?</p><p style='text-align:justify;'>- Cuando llegué a casa, me di cuenta de que _________ las llaves en la oficina, entonces tuve que volver a buscarlas. Luego me duché y fui al restaurante, pero ya era tarde.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B1G2 = ["<p>- Te ves cansado. ¿Cuándo tienes vacaciones?</p><p>Cuando ___________ este proyecto. ¡Estamos trabajando mucho para terminarlo pronto!</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B1G3 = ["<p>- ¿Con quién estabas hablando ayer por la noche en la puerta del cine?</p><p>- Con Marcos, un hombre __________ trabaja con mi padre.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B1G4 = ["<p>- ¿Podrías enviarle un correo al director de la empresa para explicarle lo que pasó ayer?</p><p>- Ya ___________ lo envié hoy temprano.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B1L1 = ["<p>El examen es muy difícil, por eso necesito __________ todas las unidades del libro.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B1L2 = ["<p>- ¿Cómo fue tu primera entrevista de trabajo?</p><p style='text-align:justify';>- ¡Muy difícil! Me preguntaron si alguna vez había trabajado en una empresa de medios, ¡pero yo no tenía experiencia! Por suerte, ____________ me dieron el puesto.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B1L3 = ["<p>Cuando me avisaron que había reprobado el examen, __________.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B1L4 = ["<p>Juan Carlos está contento porque ________ una beca y el próximo semestre va a ir a estudiar a Francia.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B1F1 = ["<p>- Me contaron que Mariana dejó la universidad y se va de viaje por un año. A mí no me parece mal, ¿tú qué opinas?</p><p>- __________________</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B1F2 = ["<p>- No encuentro mis llaves, ¿las viste?</p><p>- No, pero ___________ en el auto.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B1F3 = ["<p>- ¿Qué ___________ este vestido para la fiesta del sábado?</p><p>¡Me encanta!</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B2G1 = ["<p>- ¿Has visto los precios de los vuelos a Asia? ¡Subieron muchísimo!</p><p>- Sí, yo quería viajar este año pero lamentablemente no tengo suficiente dinero. Ojalá los _________ con anticipación.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B2G2 = ["<p>- Necesito pedirte un favor, ¿me prestarías tu coche para salir con una chica que conocí en una fiesta?</p><p>- Claro, _____________ me lo devuelvas el domingo antes del mediodía.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B2G3 = ["<p>- Buenos días, ¿en qué puedo ayudarlo?</p><p>- Buen día, estoy buscando un libro de cocina que _______ recetas bajas en calorías, y si es posible también recetas vegetarianas. ¿Tiene alguno?</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B2G4 = ["<p>- ¿Qué pasó aquí?</p><p>- _________ la jarra con el jugo y se rompió. Pero limpiaré todo, no te preocupes.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B2G5 = ["<p>Los socios del club están enfadados ___________ el mejor jugador sufrió una lesión grave en el entrenamiento y no jugará en el campeonato.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B2L1 = ["<p>Las investigaciones ______ que, incluso en la época durante la que se escribían más cartas en el Reino Unido, el ciudadano medio solo recibía una carta cada dos semanas.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B2L2 = ["<p>Cada vez más gente utiliza los teléfonos inteligentes para realizar compras por internet. El año pasado, el porcentaje de compras realizadas con teléfonos inteligentes ___________ un 10%.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B2L3 = ["<p>- Carlos, la _______ del teléfono de este mes es bastante más alta, ¿qué ha pasado?</p><p>- He tenido que hacer algunas llamadas internacionales, pero no te preocupes. A partir de ahora las haré por Internet.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B2L4 = ["<p>- No puedo trabajar más, me duele mucho la cabeza.</p><p>- Toma, aquí tienes _________. Esto te va a ayudar.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B2L5 = ["<p>Ayer por la noche en el congreso, los ___________ aprobaron una ley que regula la producción y la gestión de residuos en las ciudades.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B2F1 = ["<p style='text-align:justify;'>Las entrevistas de trabajo son un proceso que genera nervios y ansiedad en el candidato. Durante el encuentro, se evalúan conocimientos relacionados con el puesto en cuestión, ________ habilidades y competencias generales.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B2F2 = ["<p>- Ayer fui a ver la nueva exposición en el Museo de Arte Moderno. Iba a ir con un amigo pero tuvo que trabajar hasta tarde, así que fui solo.</p><p>- ¡ _________ que no me hayas dicho nada! Yo iré el próximo fin de semana, pero podría haber ido contigo.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B2F3 = ["<p>He finalizado mi carrera de grado y quisiera comenzar un máster el próximo año. ___________ que me enviara información sobre el proceso de solicitud de beca.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B2F4 = ["<p>- ¿Dónde está Pedro? ¿No ha llegado aún? Ayer me dijo que vendría a las 17:00 y ya son las 17:30.</p><p>- No, todavía no ha llegado y no puedo comunicarme con él. ¿_____________ el tren?</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_B2F5 = ["<p>Estimado Sr. García:</p><p>Tengo el gusto de dirigirme a Ud. con el objeto de postularme al puesto ofrecido en el anuncio publicado el día 3 de junio en el sitio web de la empresa.<br>[…]<br>Quedo a su disposición para facilitarle cualquier otra información.</p><p>___________,</p><p>M. Herrera</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_C1G1 = ["<p style='text-align:justify;'>Según información difundida por la Organización Mundial de la Salud, la inactividad física representa un peligro para la salud de las personas, particularmente para aquellos _________ edades oscilan entre los 30 y los 70 años.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_C1G2 = ["<p style='text-align:justify;'>Los trabajadores con más experiencia en puestos de responsabilidad desarrollan ciertas estrategias para poner límites, ______ las obligaciones del mundo del trabajo alteren lo menos posible la vida familiar.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_C1G3 = ["<p style='text-align:justify;'>A partir de ahora, los teléfonos celulares pueden utilizarse en los colegios secundarios con fines pedagógicos __________ algunos especialistas en la materia no estén de acuerdo con esa decisión.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_C1L1 = ["<p>Los sistemas educativos de éxito han encontrado maneras de distribuir los recursos para igualar las condiciones de los estudiantes que ________ de los recursos materiales y humanos de los que sí disponen los estudiantes de entornos privilegiados.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_C1L2 = ["<p>Los estudiantes que realicen prácticas profesionales en otros organismos deberán ___________ a los horarios, normas y reglamentos del mismo.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_C1L5 = ["<p style='text-align:justify;'>Para plantear una hipótesis adecuada, se deben emplear términos claros y concretos. Una hipótesis sin referencia empírica constituye un juicio de valor. Si no puede ser __________ empíricamente, desde el punto de vista científico no tiene validez.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_C1F1 = ["<p>Una investigación reveló que mantener una temperatura cálida constante en un ambiente cerrado no es favorable para la salud del organismo. __________, la variación gradual del clima puede servir para combatir la obesidad y la diabetes tipo 2.</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
var preguntas_C1F3 = ["<p>- Mariela, qué suerte que te encuentro, ¿qué haces este fin de semana? Estoy organizando una fiesta, ¿quieres venir?</p><p>- ____________, pero justamente este sábado tengo una reunión familiar a la que no puedo faltar. ¡Gracias de todos modos!</p><p>&nbsp;<br><b>Opciones:</b></p>"];
...
// Para poner número en las preguntas. Llamar en on_start con los valores del estimulo
function stim(estim, pregunta, opciones){
  estim.questions = [{prompt: "<p>"+ n_preg+') '+ 'Elija la opción correcta:<br>&nbsp;</p>' +pregunta, options: opciones, horizontal: false}];
}
...
var stim_A1G1 = {
    ...
    button_label: boton,
    on_start: function(stim_A1G1){stim(stim_A1G1, preguntas_A1G1, opciones_A1G1_final);},
    on_finish: function (trial_data){
...
var stim_A1G2 = {
    ...
    button_label: boton,
    on_start: function(stim_A1G2){stim(stim_A1G2, preguntas_A1G2, opciones_A1G2_final);},
    on_finish: function (trial_data){
...
bloque_A1.push(stim_A1G2)
  ...
  var stim_A1G3 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_A1G3,
     ...
     data: {pregunta: codigo_A1G3, opciones_mostradas: opciones_A1G3_final.toString()},
      button_label: boton,
      on_start: function(stim_A1G3){stim(stim_A1G3, preguntas_A1G3, opciones_A1G3_final);},
...
bloque_A1.push(stim_A1G3)
  ...
  var stim_A1L1 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_A1L1,
    ...
    button_label: boton,
    on_start: function(stim_A1L1){stim(stim_A1L1, preguntas_A1L1, opciones_A1L1_final);},
...
bloque_A1.push(stim_A1L1)
  ...
  var stim_A1L2 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_A1L2,
     ...
     data: {pregunta: codigo_A1L2, opciones_mostradas: opciones_A1L2_final.toString()},
      button_label: boton,
      on_start: function(stim_A1L2){stim(stim_A1L2, preguntas_A1L2, opciones_A1L2_final);},
...
bloque_A1.push(stim_A1L2)
  ...
  var stim_A1L3 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_A1L3,
    ...
    button_label: boton,
    on_start: function(stim_A1L3){stim(stim_A1L3, preguntas_A1L3, opciones_A1L3_final);},
...
bloque_A1.push(stim_A1L3)
  ...
  var stim_A1F1 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_A1F1,
    ...
    button_label: boton,
    on_start: function(stim_A1F1){stim(stim_A1F1, preguntas_A1F1, opciones_A1F1_final);},
...
bloque_A1.push(stim_A1F1)
  ...
  var stim_A1F2 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_A1F2,
    ...
    button_label: boton,
    on_start: function(stim_A1F2){stim(stim_A1F2, preguntas_A1F2, opciones_A1F2_final);},
...
// Items A2
  var stim_A2G1 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_A2G1,
    ...
    data: {pregunta: codigo_A2G1, opciones_mostradas: opciones_A2G1_final.toString()},
     button_label: boton,
     on_start: function(stim_A2G1){stim(stim_A2G1, preguntas_A2G1, opciones_A2G1_final);},
...
bloque_A2.push(stim_A2G1)
  ...
  var stim_A2G2 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_A2G2,
    ...
    button_label: boton,
    on_start: function(stim_A2G2){stim(stim_A2G2, preguntas_A2G2, opciones_A2G2_final);},
...
bloque_A2.push(stim_A2G2)
  ...
  var stim_A2G3 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_A2G3,
     ...
     button_label: boton,
     on_start: function(stim_A2G3){stim(stim_A2G3, preguntas_A2G3, opciones_A2G3_final);},
...
bloque_A2.push(stim_A2G3)
  ...
  var stim_A2G4 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_A2G4,
    ...
    button_label: boton,
    on_start: function(stim_A2G4){stim(stim_A2G4, preguntas_A2G4, opciones_A2G4_final);},
...
bloque_A2.push(stim_A2G4)
  ...
  var stim_A2L1 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_A2L1,
    ...
    data: {pregunta: codigo_A2L1, opciones_mostradas: opciones_A2L1_final.toString()},
     button_label: boton,
     on_start: function(stim_A2L1){stim(stim_A2L1, preguntas_A2L1, opciones_A2L1_final);},
...
bloque_A2.push(stim_A2L1)
  ...
  var stim_A2L2 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_A2L2,
    ...
    data: {pregunta: codigo_A2L2, opciones_mostradas: opciones_A2L2_final.toString()},
     button_label: boton,
     on_start: function(stim_A2L2){stim(stim_A2L2, preguntas_A2L2, opciones_A2L2_final);},
...
bloque_A2.push(stim_A2L2)
  ...
  var stim_A2L3 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_A2L3,
    ...
    button_label: boton,
    on_start: function(stim_A2L3){stim(stim_A2L3, preguntas_A2L3, opciones_A2L3_final);},
...
bloque_A2.push(stim_A2L3)
  ...
  var stim_A2F1 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_A2F1,
    ...
    button_label: boton,
    on_start: function(stim_A2F1){stim(stim_A2F1, preguntas_A2F1, opciones_A2F1_final);},
...
bloque_A2.push(stim_A2F1)
  ...
  var stim_A2F2 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_A2F2,
    ...
    button_label: boton,
    on_start: function(stim_A2F2){stim(stim_A2F2, preguntas_A2F2, opciones_A2F2_final);},
...
bloque_A2.push(stim_A2F2)
  ...
  var stim_A2F3 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_A2F3,
    ...
    button_label: boton,
    on_start: function(stim_A2F3){stim(stim_A2F3, preguntas_A2F3, opciones_A2F3_final);},
...
// Items B1
  var stim_B1G1 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B1G1,
    ...
    button_label: boton,
    on_start: function(stim_B1G1){stim(stim_B1G1, preguntas_B1G1, opciones_B1G1_final);},
...
bloque_B1.push(stim_B1G1)
  ...
  var stim_B1G2 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B1G2,
    ...
    button_label: boton,
    on_start: function(stim_B1G2){stim(stim_B1G2, preguntas_B1G2, opciones_B1G2_final);},
...
bloque_B1.push(stim_B1G2)
  ...
  var stim_B1G3 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B1G3,
    ...
    data: {pregunta: codigo_B1G3, opciones_mostradas: opciones_B1G3_final.toString()},
     button_label: boton,
     on_start: function(stim_B1G3){stim(stim_B1G3, preguntas_B1G3, opciones_B1G3_final);},
...
bloque_B1.push(stim_B1G3)
  ...
  var stim_B1G4 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B1G4,
    ...
    button_label: boton,
    on_start: function(stim_B1G4){stim(stim_B1G4, preguntas_B1G4, opciones_B1G4_final);},
...
bloque_B1.push(stim_B1G4)
  ...
  var stim_B1L1 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B1L1,
    ...
    data: {pregunta: codigo_B1L1, opciones_mostradas: opciones_B1L1_final.toString()},
     button_label: boton,
     on_start: function(stim_B1L1){stim(stim_B1L1, preguntas_B1L1, opciones_B1L1_final);},
...
bloque_B1.push(stim_B1L1)
  ...
  var stim_B1L2 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B1L2,
    ...
    data: {pregunta: codigo_B1L2, opciones_mostradas: opciones_B1L2_final.toString()},
     button_label: boton,
     on_start: function(stim_B1L2){stim(stim_B1L2, preguntas_B1L2, opciones_B1L2_final);},
...
bloque_B1.push(stim_B1L2)
  ...
  var stim_B1L3 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B1L3,
    ...
    data: {pregunta: codigo_B1L3, opciones_mostradas: opciones_B1L3_final.toString()},
     button_label: boton,
     on_start: function(stim_B1L3){stim(stim_B1L3, preguntas_B1L3, opciones_B1L3_final);},
...
bloque_B1.push(stim_B1L3)
  ...
  var stim_B1L4 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B1L4,
    ...
    data: {pregunta: codigo_B1L4, opciones_mostradas: opciones_B1L4_final.toString()},
     button_label: boton,
     on_start: function(stim_B1L4){stim(stim_B1L4, preguntas_B1L4, opciones_B1L4_final);},
...
bloque_B1.push(stim_B1L4)
  ...
  var stim_B1F1 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B1F1,
    ...
    data: {pregunta: codigo_B1F1, opciones_mostradas: opciones_B1F1_final.toString()},
     button_label: boton,
     on_start: function(stim_B1F1){stim(stim_B1F1, preguntas_B1F1, opciones_B1F1_final);},
...
bloque_B1.push(stim_B1F1)
  ...
  var stim_B1F2 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B1F2,
    ...
    data: {pregunta: codigo_B1F2, opciones_mostradas: opciones_B1F2_final.toString()},
     button_label: boton,
     on_start: function(stim_B1F2){stim(stim_B1F2, preguntas_B1F2, opciones_B1F2_final);},
...
bloque_B1.push(stim_B1F2)
  ...
  var stim_B1F3 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B1F3,
    ...
    button_label: boton,
    on_start: function(stim_B1F3){stim(stim_B1F3, preguntas_B1F3, opciones_B1F3_final);},
...
bloque_B1.push(stim_B1F3)
  ...
  var stim_B1F4 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B1F4,
    ...
    button_label: boton,
    on_start: function(stim_B1F4){stim(stim_B1F4, preguntas_B1F4, opciones_B1F4_final);},
...
// Items B2
  var stim_B2G1 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B2G1,
    ...
    data: {pregunta: codigo_B2G1, opciones_mostradas: opciones_B2G1_final.toString()},
     button_label: boton,
     on_start: function(stim_B2G1){stim(stim_B2G1, preguntas_B2G1, opciones_B2G1_final);},
...
bloque_B2.push(stim_B2G1)
  ...
  var stim_B2G2 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B2G2,
    ...
    button_label: boton,
    on_start: function(stim_B2G2){stim(stim_B2G2, preguntas_B2G2, opciones_B2G2_final);},
...
bloque_B2.push(stim_B2G2)
  ...
  var stim_B2G3 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B2G3,
    ...
    button_label: boton,
    on_start: function(stim_B2G3){stim(stim_B2G3, preguntas_B2G3, opciones_B2G3_final);},
...
bloque_B2.push(stim_B2G3)
  ...
  var stim_B2G4 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B2G4,
    ...
    button_label: boton,
    on_start: function(stim_B2G4){stim(stim_B2G4, preguntas_B2G4, opciones_B2G4_final);},
...
bloque_B2.push(stim_B2G4)
  ...
  var stim_B2G5 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B2G5,
    ...
    button_label: boton,
    on_start: function(stim_B2G5){stim(stim_B2G5, preguntas_B2G5, opciones_B2G5_final);},
...
bloque_B2.push(stim_B2G5)
  ...
  var stim_B2L1 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B2L1,
    ...
    button_label: boton,
    on_start: function(stim_B2L1){stim(stim_B2L1, preguntas_B2L1, opciones_B2L1_final);},
...
bloque_B2.push(stim_B2L1)
  ...
  var stim_B2L2 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B2L2,
    ...
    button_label: boton,
    on_start: function(stim_B2L2){stim(stim_B2L2, preguntas_B2L2, opciones_B2L2_final);},
...
bloque_B2.push(stim_B2L2)
  ...
  var stim_B2L3 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B2L3,
    ...
    button_label: boton,
    on_start: function(stim_B2L3){stim(stim_B2L3, preguntas_B2L3, opciones_B2L3_final);},
...
bloque_B2.push(stim_B2L3)
  ...
  var stim_B2L4 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B2L4,
    ...
    button_label: boton,
    on_start: function(stim_B2L4){stim(stim_B2L4, preguntas_B2L4, opciones_B2L4_final);},
...
bloque_B2.push(stim_B2L4)
  ...
  var stim_B2L5 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B2L5,
    ...
    button_label: boton,
    on_start: function(stim_B2L5){stim(stim_B2L5, preguntas_B2L5, opciones_B2L5_final);},
...
bloque_B2.push(stim_B2L5)
  ...
  var stim_B2F1 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B2F1,
    ...
    button_label: boton,
    on_start: function(stim_B2F1){stim(stim_B2F1, preguntas_B2F1, opciones_B2F1_final);},
...
bloque_B2.push(stim_B2F1)
  ...
  var stim_B2F2 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B2F2,
    ...
    button_label: boton,
    on_start: function(stim_B2F2){stim(stim_B2F2, preguntas_B2F2, opciones_B2F2_final);},
...
bloque_B2.push(stim_B2F2)
  ...
  var stim_B2F3 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B2F3,
    ...
    button_label: boton,
    on_start: function(stim_B2F3){stim(stim_B2F3, preguntas_B2F3, opciones_B2F3_final);},
...
bloque_B2.push(stim_B2F3)
  ...
  var stim_B2F4 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B2F4,
    ...
    button_label: boton,
    on_start: function(stim_B2F4){stim(stim_B2F4, preguntas_B2F4, opciones_B2F4_final);},
...
bloque_B2.push(stim_B2F4)
  ...
  var stim_B2F5 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_B2F5,
    ...
    button_label: boton,
    on_start: function(stim_B2F5){stim(stim_B2F5, preguntas_B2F5, opciones_B2F5_final);},
...
// Items C1
  var stim_C1G1 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_C1G1,
    ...
    button_label: boton,
    on_start: function(stim_C1G1){stim(stim_C1G1, preguntas_C1G1, opciones_C1G1_final);},
...
bloque_C1.push(stim_C1G1)
  ...
  var stim_C1G2 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_C1G2,
    ...
    button_label: boton,
    on_start: function(stim_C1G2){stim(stim_C1G2, preguntas_C1G2, opciones_C1G2_final);},
...
bloque_C1.push(stim_C1G2)
  ...
  var stim_C1G3 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_C1G3,
    ...
    button_label: boton,
    on_start: function(stim_C1G3){stim(stim_C1G3, preguntas_C1G3, opciones_C1G3_final);},
...
bloque_C1.push(stim_C1G3)
  ...
  var stim_C1G4 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_C1G4,
    ...
    button_label: boton,
    on_start: function(stim_C1G4){stim(stim_C1G4, preguntas_C1G4, opciones_C1G4_final);},
...
bloque_C1.push(stim_C1G4)
  ...
  var stim_C1G5 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_C1G5,
    ...
    button_label: boton,
    on_start: function(stim_C1G5){stim(stim_C1G5, preguntas_C1G5, opciones_C1G5_final);},
...
bloque_C1.push(stim_C1G5)
  ...
  var stim_C1L1 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_C1L1,
    ...
    button_label: boton,
    on_start: function(stim_C1L1){stim(stim_C1L1, preguntas_C1L1, opciones_C1L1_final);},
...
bloque_C1.push(stim_C1L1)
  ...
  var stim_C1L2 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_C1L2,
    ...
    button_label: boton,
    on_start: function(stim_C1L2){stim(stim_C1L2, preguntas_C1L2, opciones_C1L2_final);},
...
bloque_C1.push(stim_C1L2)
  ...
  var stim_C1L3 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_C1L3,
    ...
    button_label: boton,
    on_start: function(stim_C1L3){stim(stim_C1L3, preguntas_C1L3, opciones_C1L3_final);},
...
bloque_C1.push(stim_C1L3)
  ...
  var stim_C1L4 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_C1L4,
    ...
    button_label: boton,
    on_start: function(stim_C1L4){stim(stim_C1L4, preguntas_C1L4, opciones_C1L4_final);},
...
bloque_C1.push(stim_C1L4)
  ...
  var stim_C1L5 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_C1L5,
    ...
    button_label: boton,
    on_start: function(stim_C1L5){stim(stim_C1L5, preguntas_C1L5, opciones_C1L5_final);},
...
bloque_C1.push(stim_C1L5)
  ...
  var stim_C1F1 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_C1F1,
    ...
    button_label: boton,
    on_start: function(stim_C1F1){stim(stim_C1F1, preguntas_C1F1, opciones_C1F1_final);},
...
bloque_C1.push(stim_C1F1)
  ...
  var stim_C1F2 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_C1F2,
    ...
    button_label: boton,
    on_start: function(stim_C1F2){stim(stim_C1F2, preguntas_C1F2, opciones_C1F2_final);},
...
bloque_C1.push(stim_C1F2)
  ...
  var stim_C1F3 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_C1F3,
    ...
    button_label: boton,
    on_start: function(stim_C1F3){stim(stim_C1F3, preguntas_C1F3, opciones_C1F3_final);},
...
bloque_C1.push(stim_C1F3)
  ...
  var stim_C1F4 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_C1F4,
    ...
    button_label: boton,
    on_start: function(stim_C1F4){stim(stim_C1F4, preguntas_C1F4, opciones_C1F4_final);},
...
bloque_C1.push(stim_C1F4)
  ...
  var stim_C1F5 = {type: 'survey-multi-choice', questions: [{prompt: preguntas_C1F5,
    ...
    button_label: boton,
    on_start: function(stim_C1F5){stim(stim_C1F5, preguntas_C1F5, opciones_C1F5_final);},
